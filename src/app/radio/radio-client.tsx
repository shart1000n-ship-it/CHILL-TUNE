             ...
             <button 
               ...
               className={`px-6 py-3 rounded-l-lg font-semibold transition-colors ${
                 activeTab === 'subscriptions' 
                   ...
                   : 'bg-green-800/60 text-green-200 hover:bg-green-700/80'
               }`}
             >
               📱 Subscriptions
             </button>
           ...
           {activeTab === 'subscriptions' && (
             <div className="space-y-6">
               <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                 <div className="bg-green-800/60 rounded-lg p-4 text-center border border-green-500 hover:bg-green-700/80 transition-colors">
                   <div className="text-3xl mb-3">🎧</div>
                   <div className="text-white font-bold text-lg mb-2">Basic Supporter</div>
                   <div className="text-green-200 text-2xl font-bold mb-3">$5/month</div>
                   <ul className="text-green-100 text-sm space-y-1 mb-4">
                     <li>• Ad-free listening</li>
                     <li>• Early access to new shows</li>
                     <li>• Supporter badge in chat</li>
                   </ul>
                   <a 
                     href="https://cash.app/$SDH1000N" 
                     target="_blank" 
                     rel="noopener noreferrer"
                     className="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-lg font-semibold transition-colors inline-block w-full"
                   >
                     Subscribe Now
                   </a>
                 </div>
                 
                 <div className="bg-emerald-800/60 rounded-lg p-4 text-center border border-emerald-500 hover:bg-emerald-700/80 transition-colors">
                   <div className="text-3xl mb-3">🎵</div>
                   <div className="text-white font-bold text-lg mb-2">Music Lover</div>
                   <div className="text-emerald-200 text-2xl font-bold mb-3">$10/month</div>
                   <ul className="text-emerald-100 text-sm space-y-1 mb-4">
                     <li>• All Basic benefits</li>
                     <li>• Exclusive playlists</li>
                     <li>• Request songs directly</li>
                 ...
                 <div className="bg-green-700/60 rounded-lg p-4 text-center border border-green-400 hover:bg-green-600/80 transition-colors">
                   <div className="text-3xl mb-3">🌟</div>
                   <div className="text-white font-bold text-lg mb-2">VIP Supporter</div>
                   <div className="text-green-100 text-2xl font-bold mb-3">$25/month</div>
                   <ul className="text-green-100 text-sm space-y-1 mb-4">
                     <li>• All Music Lover benefits</li>
                     <li>• Personal shoutouts on air</li>
                     <li>• Behind-the-scenes content</li>
                     <li>• Priority song requests</li>
                   ...
                   <a 
                     ...
                     target="_blank" 
                     rel="noopener noreferrer"
                     className="bg-green-500 hover:bg-green-600 text-white px-6 py-2 rounded-lg font-semibold transition-colors inline-block w-full"
                   >
                     Subscribe Now
                   </a>
                 </div>
