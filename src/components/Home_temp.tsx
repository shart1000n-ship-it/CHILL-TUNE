...
const Home: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      icon: '📹',
      title: 'Video Calls',
      description: 'High-quality video calls with friends and family like Facebook Messenger.',
    },
    {
      icon: '🛍️',
      title: 'Marketplace',
      description: 'Shop and sell products in our TikTok Shop-style marketplace.',
    },
    {
      icon: '🎬',
      title: 'GIF Support',
    ...
    },
    {
      ...
      description: 'Personalize your profile with MySpace-style backgrounds and themes.',
    },
    {
      icon: '🎵',
      title: 'Profile Music',
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-lg text-white/60 mb-12 max-w-2xl mx-auto">
              Experience the next generation of social media with features from MySpace, Facebook, Twitter, 
              Bebo, TikTok, Snapchat, and AOL Chatrooms - all in one amazing platform.
            </p>
          </div>
            ...
            <div className="card">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-white/60">MySpace-style profile customization!</p>
                </div>
              </div>
              <div className="space-y-4 mb-6">
                <div className="flex items-center space-x-3">
            ...
            <div className="card">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-white/60">Just like the good old MySpace days!</p>
                </div>
              </div>
              <div className="space-y-4 mb-6">
                <div className="flex items-center space-x-3">
            ...
            <div className="card">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-white/60">Like Facebook Messenger, but better!</p>
                </div>
              </div>
              <div className="space-y-4 mb-6">
                <div className="flex items-center space-x-3">
            ...
            <div className="card">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-white/60">TikTok Shop meets social shopping!</p>
                </div>
              </div>
              <div className="space-y-4 mb-6">
                <div className="flex items-center space-x-3">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="card">
            ...
            <p className="text-lg text-white/70 mb-8">
              ...
              compete on leaderboards, customize your profile with backgrounds and music like MySpace, and be part of the ultimate social media experience.
            </p>
            {!user && (
              <Link to="/register" className="btn-primary text-lg px-8 py-4">
                Create Your Account
